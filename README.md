...
I lean more towards frontend but I can handle the backend side too when needed ( APIs, automations)

Always looking to learn and build things that actually solve problems.
